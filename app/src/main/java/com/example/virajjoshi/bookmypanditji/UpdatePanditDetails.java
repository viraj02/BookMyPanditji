...
public class UpdatePanditDetails extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(UpdatePanditDetails.this , android.R.style.Theme_Holo_Light_Dialog_MinWidth ,mDateSetListener,year,month,day);
        ...
        myRef1 = FirebaseDatabase.getInstance().getReference().child("AdminData").child("PanditRegistration").child(userid).child("name");
        myRef2 = FirebaseDatabase.getInstance().getReference().child("AdminData").child("PanditRegistration").child(userid).child("date");
        myRef3 = FirebaseDatabase.getInstance().getReference().child("AdminData").child("PanditRegistration").child(userid).child("address");
        myRef4 = FirebaseDatabase.getInstance().getReference().child("AdminData").child("PanditRegistration").child(userid).child("mobile");
        myRef5 = FirebaseDatabase.getInstance().getReference().child("AdminData").child("PanditRegistration").child(userid).child("exp");
        ...
        myRef2.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                editTextDate.setText(dataSnapshot.getValue().toString());
            }
        ...
        myRef3.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                editTextAddress.setText(dataSnapshot.getValue().toString());
            }
        ...
        myRef4.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                editTextMobile.setText(dataSnapshot.getValue().toString());
            }
        ...
        myRef5.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                editTextExp.setText(dataSnapshot.getValue().toString());
            }
